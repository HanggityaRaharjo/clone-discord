  ...
  return (
    <>
      ...
      <div className="p-3 mt-12 mb-12">
        ...
        {message.map((e) => (
          <div key={e.id}>
            <BubbleChat name="Sri Widdyandri" pesan={e} />
          </div>
        ))}
      </div>
      {/* Batas */}
      <div className="bg-[#36393f] fixed w-[inherit] bottom-5  px-3">
        <div className="bg-[#40444b] py-2 px-5 rounded-lg flex justify-between items-center">
          <div className="flex items-center">
            <button>
              <svg width="25" height="25" viewBox="0 0 24 24" className="text-[#b9bbbe]">
                <path
          ...
          <div className="w-full mx-5 mb">
            <form onSubmit={handleSubmitMessage}>
              <input type="text" id="message" className="w-full bg-transparent text-white focus:outline-none" />
          ...
          <div className="flex items-center gap-2 text-[#b9bbbe]">
            <button>
              <svg width="25" height="25" aria-hidden="true" role="img" viewBox="0 0 25 25">
                <path
                  fill="currentColor"
                  fillRule="evenodd"
                  clipRule="evenodd"
            ...
            <button>
              <svg width="25" height="25" className="icon-1d5zch" aria-hidden="true" role="img" viewBox="0 0 24 24">
                <path
                  fill="currentColor"
            ...
            <button>
              <svg width="23" height="23" className="stickerIcon-3Jx5SE" aria-hidden="true" role="img" viewBox="0 0 20 20">
                <path
                  fill="currentColor"
                  fillRule="evenodd"
                  clipRule="evenodd"
